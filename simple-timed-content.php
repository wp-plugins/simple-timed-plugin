...
define( 'timed_content_version', '1.2.1' );
...
function timed_content_plugin_meta( $links, $file ) {
	...
	if ( strpos( $file, 'simple-timed-content.php' ) !== false ) {
		$links = array_merge( $links, array( '<a href="https://wordpress.org/support/plugin/simple-timed-plugin">' . __( 'Support', 'simple-content-reveal' ) . '</a>' ) );
